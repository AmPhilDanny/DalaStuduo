          ...
          {user ? (
            <div className="mt-4 border-t border-border pt-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <Link to={profile?.role === 'firm' ? '/dashboard/org' : '/dashboard'} onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 text-sm font-medium text-muted-foreground hover:text-primary py-2.5 px-2 rounded-md hover:bg-muted/50 transition-colors">
